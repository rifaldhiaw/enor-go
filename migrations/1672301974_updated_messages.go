...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		collection.ListRule = types.Pointer("@request.auth.organization.id = user.organization.id")

		collection.ViewRule = types.Pointer("@request.auth.organization.id = user.organization.id")
